...
define("ip_admin", get_template_directory() . '/inc/shortcodes/');

// Shortcodes
require_once(ip_admin . 'theme-shortcodes.php');
...
function html5blank_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/js/scripts.js', array('jquery'), filemtime( get_stylesheet_directory() . '/js/scripts.js' ) ); // Custom scripts
...
{
    if (is_page('pagenamehere')) {
        wp_register_style('stylename', get_template_directory_uri() . '/css/stylename.css', array(), '1.0', 'all');
        wp_enqueue_style('stylename'); // Conditional Style
    }
}
...
add_action('wp_enqueue_scripts', 'conditional_styles'); // Add Conditional Page Styles
